// Background job registry: one running bash process plus its live output
// channels, alive independently of the MCP request that started it (a request
// timeout would otherwise kill it). job_output / job_list / job_kill are the
// only ways to read or stop a job. See DESIGN §5.10.
